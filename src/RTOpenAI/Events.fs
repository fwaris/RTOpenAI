...
type InputAudioTranscription =
    ...
    static member Default = { model = "whisper-1"; enabled=None}
...
type Session =
    ...
    static member Default = 
        { 
            ...
            instructions = None
            voice = Some ("alloy")
            input_audio_format = Some ("pcm16")
            output_audio_format = Some ("pcm16"); 
            input_audio_transcription = Some InputAudioTranscription.Default
            turn_detection = Some TurnDetection.Default
            tools = []
            tool_choice = Some "auto" //How the model chooses tools. Options are "auto", "none", "required", or specify a function.
...
type ConversationItemContent =
    ...
    static member Default = { ``type`` = ContentType.Input_audio; text = None; transcript = None; audio=None}
...
type Response =
    ...
    static member Default = 
        { 
            modalities = []; instructions = None; voice = "alloy"; output_audio_format = None; tools = []
