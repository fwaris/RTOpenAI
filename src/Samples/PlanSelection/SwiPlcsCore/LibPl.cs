...
// ReSharper restore InconsistentNaming
		...
		private static void LoadUnmanagedLibrary(string fileName)
        {
			if (_hLibrary == null)
			{
                _hLibrary = new SafeLibraryHandle(System.Runtime.InteropServices.NativeLibrary.Load(fileName));
...
#warning _PL_X64 is NOT defined
            ...
            IntPtr addressStdStreamArray = System.Runtime.InteropServices.NativeLibrary.GetExport(_hLibrary.DangerousGetHandle(), "S__iob");            
